<template>
	<div>
		...
		<h1 class='m-about-title'>
			<strong><span>Equipa</span></strong>
		</h1>
		<p>&nbsp;</p>

		<p class='m-about-text'>
			<span>A nossa equipa é composta por alunos de todos os cursos de Engenharia do Instituto Superior Técnico
			</span>
		</p>

		<div id='teamImgsCarousel' class='carousel slide' data-ride='carousel'>
		...
		<div v-for='dep in departments'>
			...
			<p>&nbsp;</p>
			<h1 class='m-about-title'>
				<strong><span>{{dep.name}}</span></strong>
			</h1>
			<p>&nbsp;</p>

			<div v-for='m in dep.members'>

				<member-card :member='m' />
