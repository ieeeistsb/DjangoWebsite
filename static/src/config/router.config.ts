...
// @ts-ignore
import { NotFoundView, HomeView, CommunityView, AboutView, TeamView, MembersView, EventsView, NewsletterView, } from '../views/index.ts';
			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						props: true,
						meta: { title: 'Newsletter', type: 'newsletter', },
					}
				]
			},
			{
